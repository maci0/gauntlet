...
- Review Kubernetes manifests, Helm templates, and Kustomize overlays; read a Dockerfile only to verify PID 1, USER, and probe paths named by those manifests. Helm chart authoring and templating belong to helm-review; docker-compose belongs to infra-review. Do not query live cluster endpoints or running pods.
